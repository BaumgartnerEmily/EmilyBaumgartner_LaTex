%%if
\section{Exemples}
Dans cette **section**, nous allons voir divers exemples de mises en page, d'ajout d'élement et autres outils disponible avec \LaTeX~.

\subsection{Equation}
Nous avons la possibilité de créer simplement des équations et de les utiliser. Nous pouvons aussi les exporter, les réutiliser ou encore les modifier sans difficulté.
\begin{equation} \label{eq:1}
    {R}_{\mu v} - \frac{1}{2}R{g}_{\mu v}+\varLambda {g}_{\mu v}=\frac{8\pi G}{C^4}{T}_{\mu v}
\end{equation}
\label{Equation}

\subsection{Diagrammes}
De même que pour les équations, nous avons la possibilités d'utiliser des diagrammes.
